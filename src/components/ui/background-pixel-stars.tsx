...
export const BackgroundPixelStars = memo(
  () => {
    ...
    const shootingTimeoutsRef = useRef<ReturnType<typeof setTimeout>[]>([]);
    ...
    useEffect(() => {
      ...
      const createShootingStar = (): void => {
        ...
        const id = setTimeout(createShootingStar, randomDelay);
        shootingTimeoutsRef.current.push(id);
      };
      ...
      return () => {
        ...
        shootingTimeoutsRef.current.forEach(clearTimeout);
        shootingTimeoutsRef.current = [];
